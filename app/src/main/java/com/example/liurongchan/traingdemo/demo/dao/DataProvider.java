...
public class DataProvider extends ContentProvider {
    ...
    public static final Uri DIARY_CONTENT_URI = Uri.parse(SCHEME + AUTHORITY + PATH_DIARY);

    private static final int DIARY = 0;


    public static final String FEED_CONTENT_TYPE = "vnd.android.cursor.dir/vnd.fenjuly.diary";
    ...
    private String matchTable(Uri uri) {
        ...
        switch (sUriMatcher.match(uri)) {
            case DIARY:
                table = DiaryDataHelper.DiaryDB.TABLE_NAME;
                break;
            default:
                throw new IllegalArgumentException("Unknown URI " + uri);
        }
